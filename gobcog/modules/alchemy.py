...
class Alchemy:
    ...
    recipes = {"DaisyDaisyTongue Sprout": {"yields":".vial_of_wit", "uses": (1,6)},
                ...
                "DaisyMushroomTongue Sprout": {"yields":".cunning_vial", "uses": (3,4)},
                "DaisyReedsReeds": {"yields":".vial_of_wit", "uses": (2,4)},
                "DaisyDaisyReeds": {"yields":".vial_of_wit", "uses": (1,2)},
                "DaisyMushroomReeds": {"yields":".cunning_vial", "uses": (1,2)},
                "DaisyMushroomOilflower": {"yields":".vial_of_aggression", "uses": (1,6)},
                "DaisyOilflowerOilflower": {"yields":".malevolent_vial", "uses": (1,6)},
                ...
                "Tongue SproutTongue SproutTwolip": {"yields":".cunning_vial", "uses": (5,10)},
                ...
                "MushroomMushroomRaging Frills": {"yields":".malevolent_vial", "uses": (4,8)},
